                ...
                <div class="login-area">
                    <div class="login-wrapper">
                        <div class="login-wrapper__top">
                            <a href="<?php echo e(route('home')); ?>"> <h3 class="title text-white"><?php echo app('translator')->get('Welcome to'); ?> <strong><?php echo e(__($general->site_name)); ?></strong> </h3></a>
...
<?php endif; ?>
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <a href="<?php echo e(route('doctor.password.reset')); ?>"
...
<?php echo $__env->make('doctor.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\kerfapthostgit\core\resources\views/doctor/auth/login.blade.php ENDPATH**/ ?>